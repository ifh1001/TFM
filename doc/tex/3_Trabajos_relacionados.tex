...
%
% Lo de decir que no hay es muy fuerte. Mejor decir que hay un número 
% limitado o similar. Considera por ejemplo los de abajo: 
% Research on Zinc Layer Thickness Prediction Based on LSTM Neural Network. Z Lu, Y Liu, S Zhong - 2021 33rd Chinese Control and Decision …, 2021 - ieeexplore.ieee.org
%
% Coating thickness modeling and prediction for hot-dip galvanized steel strip based on GA-BP neural network. K Mao, YL Yang, Z Huang… - 2020 Chinese control and …, 2020 - ieeexplore.ieee.org

% Study and prediction of the zinc coating weight inside a galvanizing line. Q Lowette - 2021 - matheo.uliege.be
